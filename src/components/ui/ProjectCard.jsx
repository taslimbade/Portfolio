...
const ProjectCard = ({project}) => {
  ...
  return (
    <div className="group relative h-full min-h-[520px] bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-primary/30 transition-all duration-300 flex flex-col">
